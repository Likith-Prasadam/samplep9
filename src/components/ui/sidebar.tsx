  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[inset-inline,width] duration-200 ease-linear md:flex shadow-sm',
          side === 'left'
...
export {
  ...
  SidebarMenuSubItem,
  ContextProvider as SidebarProvider,
  SidebarRail,
  SidebarSeparator,
  SidebarTrigger,
